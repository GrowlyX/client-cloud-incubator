...
public class AWSAlbUserClaimsJwkProvider implements JwkProvider {
     ...
     */
    public static final String US_EAST_1_ALB_KEY_ENDPOINT = "https://public-keys.auth.elb.us-east-1.amazonaws.com";
    ...
    public static JwkProvider createProvider() {
        return createProviderInt(US_EAST_1_ALB_KEY_ENDPOINT, null);
    }
